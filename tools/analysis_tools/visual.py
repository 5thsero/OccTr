...
if __name__ == '__main__':
    nusc = NuScenes(version='v1.0-trainval', dataroot='/home/fqf/BEVFormer-ud-cross/data/nuscenes', verbose=True)
    # render_annotation('7603b030b42a4b1caa8c443ccc1a7d52')
    bevformer_results = mmcv.load(
    '/home/fqf/BEVFormer-ud-cross/test/bevformer_tiny/Wed_Nov__8_07_31_24_2023/pts_bbox/results_nusc.json')
    save_dir = "tiny_result"
